...
#define container_of(ptr, type, member) ({			\
	const typeof( ((type *)0)->member ) *__mptr = (ptr);	\
		(type *)( (s8 *)__mptr - offsetof(type,member) );})
#endif
/*
...
#else
extern void list_add(struct list_head *new_list, struct list_head *head);
#endif
 ...
 */
static inline void dpi_list_move(struct list_head *list, struct list_head *head)
{
